    ...
    async def _create_error_response(
        ...
        return JSONResponse(
            ...
            headers={
                ...
                "X-Error-Category": context.category.value
            }
        )
                ...
                for attempt in range(max_retries + 1):
                    try:
                        ...
                        if attempt < max_retries:
                            ...
                            self.logger.info(f"Retrying {func.__name__} in {wait_time}s (attempt {attempt + 1})")
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "last_error": self.error_stats["last_error_time"].isoformat() if self.error_stats["last_error_time"] else None
            }
