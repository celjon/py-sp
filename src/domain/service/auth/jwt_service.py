...
class JWTService:
    ...
    def __init__(
        ...
        print(
            f"🔐 JWT Service инициализирован (алгоритм: {algorithm}, access: {access_token_expire_minutes}m)"
        )

    def create_token_pair(
        self, api_key_id: str, client_name: str, plan: str, permissions: list = None
    ) -> TokenPair:
        """
    ...
    def validate_token(self, token: str, expected_type: TokenType = None) -> TokenValidationResult:
        ...
        try:
            ...
            return TokenValidationResult(is_valid=False, error=f"Token validation error: {str(e)}")
    ...
    def get_token_info(self, token: str) -> Dict[str, Any]:
        ...
        info = {"is_valid": validation_result.is_valid, "error": validation_result.error}
